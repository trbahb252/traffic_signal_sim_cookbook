...
char CONTROLLER_DLL_NAME[MAX_PATH];
    ...
    switch (type) {      
      ...
      case SC_DLL_DATA_SG_GREENEND:
      {
        ...
        if (sg_i < 0) {
          ...
          *double_value = LSA_Puffer->SigGr[sg_i]->TGruenende;
          return 1;
        }
      ...
      case SC_DLL_DATA_SG_REDEND:
      {
        ...
        if (sg_i < 0) {
          ...
          *double_value = LSA_Puffer->SigGr[sg_i]->TRotende;
          return 1;
        }
      ...
      case SC_DLL_DATA_SG_GREENEND2:
      {
        ...
        if (sg_i < 0) {
          ...
          *double_value = LSA_Puffer->SigGr[sg_i]->TGruenende2;
          return 1;
        }
      ...
      case SC_DLL_DATA_SG_REDEND2:
      {
        ...
        if (sg_i < 0) {
          ...
          *double_value = LSA_Puffer->SigGr[sg_i]->TRotende2;
          return 1;
        }
