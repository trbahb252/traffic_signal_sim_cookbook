...
std::string SG_Name(unsigned long sc_no, unsigned long det_no);
...
/* The value is for informational purposes. VISSIM returns this value   */
/* in the COM interface to clients that wants to get a hint of the next */
/* green end for example. The value is based on the cycle second.        */
/* If controller no. <sc_no> or signal group no. <sg_no> does not exist */
...
/* The value is for informational purposes. VISSIM returns this value   */
/* in the COM interface to clients that wants to get a hint of the next */
/* red end for example. The value is based on the cycle second.         */
/* If controller no. <sc_no> or signal group no. <sg_no> does not exist */
/* in the VISSIM network or a runtime error occurs and the return value */
/* is 0, else the return value is 1.                                    */
...
/* The value is for informational purposes. VISSIM returns this value   */
/* in the COM interface to clients that wants to get a hint of the next */
/* green end 2 for example. The value is based on the cycle second.     */
/* If controller no. <sc_no> or signal group no. <sg_no> does not exist */
/* in the VISSIM network or a runtime error occurs and the return value */
/* is 0, else the return value is 1.                                    */
...
/* The value is for informational purposes. VISSIM returns this value   */
/* in the COM interface to clients that wants to get a hint of the next */
/* red end 2 for example. The value is based on the cycle second.       */
/* If controller no. <sc_no> or signal group no. <sg_no> does not exist */
/* in the VISSIM network or a runtime error occurs and the return value */
/* is 0, else the return value is 1.                                    */
